import{_ as s,c as a,o as i,a4 as n}from"./chunks/framework.DzXn47Ma.js";const A=JSON.parse('{"title":"flex","description":"","frontmatter":{},"headers":[],"relativePath":"column/ClassCSS/flex.md","filePath":"column/ClassCSS/flex.md"}'),l={name:"column/ClassCSS/flex.md"},e=n(`<h1 id="flex" tabindex="-1">flex <a class="header-anchor" href="#flex" aria-label="Permalink to &quot;flex&quot;">​</a></h1><h2 id="属性" tabindex="-1">属性 <a class="header-anchor" href="#属性" aria-label="Permalink to &quot;属性&quot;">​</a></h2><h3 id="父" tabindex="-1">父 <a class="header-anchor" href="#父" aria-label="Permalink to &quot;父&quot;">​</a></h3><div class="language-scss vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">scss</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">flex-direction: row; </span><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">// row-reverse | column | column-reverse</span></span>
